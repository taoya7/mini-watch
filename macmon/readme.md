...
```jsonc
{
  ...
  "fans_number": 4344,                // Sum of fan speeds in RPM
  "fans": [                           // Fan speed in RPM
    { "id": "0", "rpm": 2160 },
    { "id": "1", "rpm": 2184 }
  ],
...
macmon_fans_number{chip="Apple M3 Pro"}
macmon_fan_speed_rpm{chip="Apple M3 Pro",fan="0"}
```
...
# HELP macmon_fans_number Sum of fan speeds in RPM
# TYPE macmon_fans_number gauge
macmon_fans_number{chip="Apple M3 Pro"} 4344

# HELP macmon_fan_speed_rpm Fan speed in RPM
# TYPE macmon_fan_speed_rpm gauge
macmon_fan_speed_rpm{chip="Apple M3 Pro",fan="0"} 2160
